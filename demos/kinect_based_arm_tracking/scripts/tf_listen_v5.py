...
def track_one_arm(shoulder, shoulder_x, elbow, hand, torso, head, base, listener, limb, limb_name):
    ...
    if flags[limb_name]:
    	...
    	cmd[limb_name+'_s0'] = (radius_s0-prev_data[limb_name][0])/lapse
    	cmd[limb_name+'_s1'] = (radius_s1-prev_data[limb_name][1])/lapse
    	cmd[limb_name+'_e0'] = (radius_e0-prev_data[limb_name][2])/lapse
    	cmd[limb_name+'_e1'] = (radius_e1-prev_data[limb_name][3])/lapse
