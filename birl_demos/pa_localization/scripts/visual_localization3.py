...
class visual_localization:
  def __init__(self):
    ...
    self.thread_pub = rospy.Publisher("pa_image/thresh",Image)
  ...
  def callback(self,data):
    ...
    try:
      ...
      img_roi=img_gray[116:350,16:640]
      img_0=copy(img_roi)
      ...
      self.pick_location0.x=cx_leap/0.945/1000.0
      self.pick_location0.y=cy_leap/0.945/1000.0
      ...
      if(len(cntrs)>=3):
        ...
        self.pick_location1.x=cx_box/0.945/1000.0
        self.pick_location1.y=cy_box/0.945/1000.0
    ...
    try:
      ...
      self.location_pub.publish(self.pick_location0)
      self.location_pub.publish(self.pick_location1)
    except CvBridgeError as e:
      print(e)
