...
class GoHome():
    def __init__(self):
        ...
        l_home_angles = {'left_s0': 0.6615292147755847,
                         'left_s1': 0.016490293469768196,
                         'left_e0': 0.04716990922747647,
                         'left_e1': 1.4254516471425207,
                         'left_w0': 0.009203884727312482,
                         'left_w1': 0.2949078064709708,
                         'left_w2': -0.004985437560627594}
